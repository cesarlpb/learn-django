...
# SECURITY WARNING: keep the secret key used in production secret!
    ...
    # TODO: colocar aqui lógica para que si no encuentra el archivo, que lo cree -> coloque un secret key aleatorio de 50 chars
...
LANGUAGE_CODE = 'es-es' # 'en-us' = inglés por defecto

TIME_ZONE = 'Europe/Madrid' # 'UTC' = GMT+0 y para España es GMT+1
